...
class PageCalendar extends HTMLElement {
    connectedCallback() {
        this.innerHTML = /*html*/ `
        <ui-modal id="event-modal"></ui-modal>
        ...
        <div class="calendar bg-white border border-gray-200 rounded-lg m-8 shadow-sm">
            <div class="head flex justify-between p-6 border-b border-gray-100">
                <div class="flex gap-2 items-center">
                    ...
                    <button data-modal-target="event-modal" data-modal-toggle="event-modal" class="h-10 rounded-md bg-blue-600 hover:bg-blue-700 px-4 text-white cursor-pointer font-medium transition-colors text-sm">Добавить Событие +</button>
                </div>
            ...
            <div id="week-view" class="hidden">
                ...
                <div class="bg-white">
                    <div class="flex border-b border-gray-100">
                        <div class="w-20 text-xs text-gray-400 py-2 pr-2 text-right">весь день</div>
