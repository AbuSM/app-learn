class DeleteIcon extends HTMLElement {
    connectedCallback() {
        ...
        // this.style.display = "inline-flex"; // чтобы выровнять по линии
        // this.style.alignItems = "center"; // центрировать SVG по вертикали
...
customElements.define("history-delete-icon", DeleteIcon);
